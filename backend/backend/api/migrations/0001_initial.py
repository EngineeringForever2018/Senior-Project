# Generated by Django 3.1.5 on 2021-04-30 05:49

import backend.api.models.fields
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile', backend.api.models.fields.NBField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preprocessed_text', backend.api.models.fields.NBField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(related_name='classrooms', to='api.Student')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dummy', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.dummy')),
            ],
        ),
    ]
